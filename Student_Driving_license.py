...
label_id=Label(root,bg="white",fg="black")
label_id.place(relx=0.1,rely=0.2,anchor=CENTER)

label_name=Label(root,bg="white",fg="black")
label_id.place(relx=0.1,rely=0.4,anchor=CENTER)

label_dob=Label(root,bg="white",fg="black")
label_id.place(relx=0.1,rely=0.5,anchor=CENTER)

label_pin=Label(root,bg="white",fg="black")
label_id.place(relx=0.1,rely=0.6,anchor=CENTER)

label_address=Label(root,bg="white",fg="black")
label_id.place(relx=0.1,rely=0.7,anchor=CENTER)

label_vehicle_type=Label(root,bg="white",fg="black")
label_id.place(relx=0.1,rely=0.8,anchor=CENTER)

# Define the function
def define():
    lid="3794827384"
    name="Riya Mallampati"
    dob="8 October 2010"
    pin="937469"
...
button1=Button(root,text="Show License",command=define,bg="white",fg="black")
